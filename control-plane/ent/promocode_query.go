...
type PromoCodeQuery struct {
	...
	withUsages *PromoCodeUsageQuery
...
func (_q *PromoCodeQuery) QueryUsages() *PromoCodeUsageQuery {
...
func (_q *PromoCodeQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *PromoCodeQuery) FirstIDX(ctx context.Context) string {
...
func (_q *PromoCodeQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *PromoCodeQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *PromoCodeQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *PromoCodeQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PromoCodeQuery) WithUsages(opts ...func(*PromoCodeUsageQuery)) *PromoCodeQuery {
	query := (&PromoCodeUsageClient{config: _q.config}).Query()
...
func (_q *PromoCodeQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*PromoCode, error) {
	...
	if query := _q.withUsages; query != nil {
		if err := _q.loadUsages(ctx, query, nodes,
			func(n *PromoCode) { n.Edges.Usages = []*PromoCodeUsage{} },
			func(n *PromoCode, e *PromoCodeUsage) { n.Edges.Usages = append(n.Edges.Usages, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *PromoCodeQuery) loadUsages(ctx context.Context, query *PromoCodeUsageQuery, nodes []*PromoCode, init func(*PromoCode), assign func(*PromoCode, *PromoCodeUsage)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*PromoCode)
	for i := range nodes {
...
func (_q *PromoCodeQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(promocode.Table, promocode.Columns, sqlgraph.NewFieldSpec(promocode.FieldID, field.TypeString))
	_spec.From = _q.sql
