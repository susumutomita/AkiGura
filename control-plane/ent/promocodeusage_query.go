...
func (_q *PromoCodeUsageQuery) QueryTeam() *TeamQuery {
...
func (_q *PromoCodeUsageQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *PromoCodeUsageQuery) FirstIDX(ctx context.Context) string {
...
func (_q *PromoCodeUsageQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *PromoCodeUsageQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *PromoCodeUsageQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *PromoCodeUsageQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PromoCodeUsageQuery) WithTeam(opts ...func(*TeamQuery)) *PromoCodeUsageQuery {
	query := (&TeamClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *PromoCodeUsageQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*PromoCodeUsage, error) {
	...
	if query := _q.withTeam; query != nil {
		if err := _q.loadTeam(ctx, query, nodes, nil,
			func(n *PromoCodeUsage, e *Team) { n.Edges.Team = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *PromoCodeUsageQuery) loadTeam(ctx context.Context, query *TeamQuery, nodes []*PromoCodeUsage, init func(*PromoCodeUsage), assign func(*PromoCodeUsage, *Team)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*PromoCodeUsage)
	for i := range nodes {
...
func (_q *PromoCodeUsageQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(promocodeusage.Table, promocodeusage.Columns, sqlgraph.NewFieldSpec(promocodeusage.FieldID, field.TypeString))
	_spec.From = _q.sql
