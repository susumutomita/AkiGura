...
// The GroundFunc type is an adapter to allow the use of ordinary
// function as Ground mutator.
type GroundFunc func(context.Context, *ent.GroundMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f GroundFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.GroundMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.GroundMutation", m)
}

// The MunicipalityFunc type is an adapter to allow the use of ordinary
// function as Municipality mutator.
type MunicipalityFunc func(context.Context, *ent.MunicipalityMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f MunicipalityFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.MunicipalityMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.MunicipalityMutation", m)
}
...
// The ScrapeJobFunc type is an adapter to allow the use of ordinary
// function as ScrapeJob mutator.
type ScrapeJobFunc func(context.Context, *ent.ScrapeJobMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ScrapeJobFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ScrapeJobMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ScrapeJobMutation", m)
}
...
func (f SlotFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SlotMutation); ok {
		return f(ctx, mv)
	}
...
// The WatchConditionFunc type is an adapter to allow the use of ordinary
// function as WatchCondition mutator.
type WatchConditionFunc func(context.Context, *ent.WatchConditionMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f WatchConditionFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.WatchConditionMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.WatchConditionMutation", m)
}
